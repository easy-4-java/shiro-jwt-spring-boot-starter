...
**shiro-jwt-spring-boot-starter** is a Spring Boot starter that integrates **jwt-issuer-api** for applications using jwt-issuer-api. It provides auto-configuration, property binding, and ready-to-use beans so that applications can consume jwt-issuer-api capabilities with minimal setup.
...
| JDK | `17` |
| Coordinates | `io.github.easy4j:shiro-jwt-spring-boot-starter:3.3.x.20260527-SNAPSHOT` |
